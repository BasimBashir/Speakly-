...
/**
 * Edit user-provided document fields
 *
 ...
 */
export const editDocumentInputsApiV1KnowledgeBaseDocumentsDocumentUuidPatch = <ThrowOnError extends boolean = false>(options: Options<EditDocumentInputsApiV1KnowledgeBaseDocumentsDocumentUuidPatchData, ThrowOnError>) => (options.client ?? client).patch<EditDocumentInputsApiV1KnowledgeBaseDocumentsDocumentUuidPatchResponses, EditDocumentInputsApiV1KnowledgeBaseDocumentsDocumentUuidPatchErrors, ThrowOnError>({
...
/**
 * Re-extract the DocCard for a document
 *
 ...
 */
export const reExtractDocCardApiV1KnowledgeBaseDocumentsDocumentUuidReExtractPost = <ThrowOnError extends boolean = false>(options: Options<ReExtractDocCardApiV1KnowledgeBaseDocumentsDocumentUuidReExtractPostData, ThrowOnError>) => (options.client ?? client).post<ReExtractDocCardApiV1KnowledgeBaseDocumentsDocumentUuidReExtractPostResponses, ReExtractDocCardApiV1KnowledgeBaseDocumentsDocumentUuidReExtractPostErrors, ThrowOnError>({ url: '/api/v1/knowledge-base/documents/{document_uuid}/re-extract', ...options });
...
/**
 * Auto-draft a description for an uploaded document
 *
 ...
 */
export const describePreviewApiV1KnowledgeBaseDescribePreviewPost = <ThrowOnError extends boolean = false>(options: Options<DescribePreviewApiV1KnowledgeBaseDescribePreviewPostData, ThrowOnError>) => (options.client ?? client).post<DescribePreviewApiV1KnowledgeBaseDescribePreviewPostResponses, DescribePreviewApiV1KnowledgeBaseDescribePreviewPostErrors, ThrowOnError>({
