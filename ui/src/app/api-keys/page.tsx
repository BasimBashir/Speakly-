            ...
            <div className="container mx-auto px-4 py-8">
                <div className="max-w-6xl mx-auto">
                    <div className="mb-8">
                        ...
                        <p className="text-muted-foreground">Manage your API keys to access Speakly services programmatically</p>
                    </div>
                    ...
                    {/* Speakly Service Keys Section */}
                    <Card className="mb-6">
                        <CardHeader>
                            <div className="flex justify-between items-center">
                                <div>
                                    <CardTitle>Speakly Service Keys</CardTitle>
                                    <CardDescription>
                                        Manage service keys for accessing Speakly AI services (LLM, TTS, STT)
                                    </CardDescription>
                                </div>
                                <div className="flex gap-2">
            ...
            <Dialog open={isCreateServiceDialogOpen} onOpenChange={setIsCreateServiceDialogOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Create a service key to access Speakly AI services (LLM, TTS, STT)
                        </DialogDescription>
                    </DialogHeader>
                    <div className="grid gap-4 py-4">
                        <div className="grid gap-2">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="p-4 bg-blue-500/10 border border-blue-500/20 rounded-lg">
                                <p className="text-sm text-blue-600 dark:text-blue-500">
                                    This key provides access to Speakly AI services including LLM, Text-to-Speech, and Speech-to-Text.
